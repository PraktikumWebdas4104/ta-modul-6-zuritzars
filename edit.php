...
<form method="POST">
	<table>
		<tr>
			<td>NIM</td>
			<td>:</td>
			<td><input type="text" name="nim" maxlength="10" value="<?php echo $_SESSION['nim'];?>"></td>
		</tr>
		<tr>
			<td>Nama</td>
			<td>:</td>
...
<?php
	...
	$sql = $koneksi->query("UPDATE `daftar` SET `nim`='$nim',`nama=`'$nama',`password`='$password',`kelas`='$kelas',`jeniskelamin`='$jeniskelamin',`hobi`='$hobi',`fakultas`='$fakultas',`alamat`='$alamat'");
	}else{
